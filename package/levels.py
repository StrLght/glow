...
class Level7(Level):
	...
	def run(self):
		...
		self.eng.add_entity(entity.Entity('pic2.png',780,330,scale=(30,30)))
		self.eng.add_entity(entity.Entity('pic2.png',900,340,scale=(30,30)))
		self.eng.add_entity(entity.Entity('pic2.png',1040,350,scale=(30,30)))
		self.eng.add_entity(entity.Entity('pic2.png',1150,335,scale=(30,30)))
		self.eng.add_entity(entity.Entity('pic2.png',1250,315,scale=(30,30)))
		self.eng.add_entity(entity.Entity('pic2.png',1350,300,scale=(30,30)))
		self.eng.add_entity(entity.Entity('pic2.png',1450,285,scale=(30,30)))
		self.eng.add_entity(entity.Entity('pic2.png',1450,285,scale=(130,30)))
		self.eng.add_entity(entity.Entity('exit.png',1545,241,"exit"))
		while self.going and not self.completed:
			self.needs_respawn()
			self.eng.update_camera()
			self.eng.handle_input()
