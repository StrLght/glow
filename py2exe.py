...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "StarLight"
        self.author_email = "ohaistarlight@gmail.com"
        self.copyright = "Copyright (c) 2011 StarLight."
